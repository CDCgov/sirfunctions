...
Shows the timeliness of shipment to sequencing results for specimens
that require sequencing. The target is 7 days or less.
...
`ggplot` A violin plot showing the timeliness of shipment to sequencing
results.
